...
class TransactionsPage {
  ...
  removeAccount() {
    ...
    if (this.lastOptions && confirm('Вы действительно хотите удалить текущий счёт?')) {
  ...
  removeTransaction( id ) {
    ...
    if (confirm(`Вы действительно хотите удалить текущую транзакцию?`)) {
  ...
  renderTransactions(data) {
    ...
    content.innerHTML = data.reduce((acc, element) => acc + this.getTransactionHTML(element), '');
  };
};